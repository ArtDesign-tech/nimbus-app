...
export const MODELS: ModelEntry[] = [
  ...
  { id: 'claude-opus-4.7', label: 'Claude Opus 4.7', logo: '/image/logo/claude.png', gateway: 'tunnel', upstreamId: 'kr/claude-sonnet-4.6', plans: ['pro'], maxContextTokens: 200_000, supportsVision: true },
  ...
  { id: 'minimax-m2.5', label: 'MiniMax M2.5', logo: '/image/logo/minimax-color.png', gateway: 'openrouter', upstreamId: 'minimax/minimax-m2.5', plans: ['free'], maxContextTokens: 128_000, supportsVision: false },
]
